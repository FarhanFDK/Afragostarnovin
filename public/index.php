    ...
    <div class="main grid grid-cols-1">
      ...
      <div class="middle">
        ...
        <div class="company-description text-xl">
          ...
          <p class="text-center mx-4 break-words sm:break-words md:break-all lg:truncate xl:break-normal">
          ...
          <p class="text-l mx-12 break-words sm:break-words md:break-all lg:truncate xl:break-normal">
          ...
          <p class="text-l mx-10 break-words sm:break-words md:break-all lg:truncate xl:break-normal">
        ...
        <div class="attributes my-4">
          ...
          <table class="text-center">
            <tr class="text-center mx-4">
              <td class="att-item w-30 h-20 bg-gray-200 border-none hover:border-gray-500 mx-10 text-xl sm:text-xl md:text-2xl lg:text-2xl xl:text-2xl text-center">
